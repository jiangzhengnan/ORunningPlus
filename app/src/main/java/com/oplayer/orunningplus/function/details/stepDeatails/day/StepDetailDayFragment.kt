package com.oplayer.orunningplus.function.details.stepDeatails.day
 ...
 */
class StepDetailDayFragment : BaseFragment(), OnChartValueSelectedListener {
    override fun onGetEvent(event: MessageEvent) {
        
    }

    override fun getLayoutId(): Int {
      return R.layout.fragment_step_deatail_day
    }
    ...
    override fun initView() {
        ...
        dsv_day.setListener(object : DateSelectView.onDateChageListener{
        ...
        initBarChartSetting(bc_step_detail)
        setData(bc_step_detail,getChartDate(), UIUtils.getColor(R.color.yellow_progress_color))
        initBarChartSetting(bc_distance_detail)
        setData(bc_distance_detail,getChartDate(), UIUtils.getColor(R.color.green_heart_color))
        initBarChartSetting(bc_calories_detail)
        setData(bc_calories_detail,getChartDate(), UIUtils.getColor(R.color.red_heart_color))
