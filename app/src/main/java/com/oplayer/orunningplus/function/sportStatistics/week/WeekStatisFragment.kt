...
import kotlinx.android.synthetic.main.fragment_week_statis.*

/**
 * A simple [Fragment] subclass.
 */
class WeekStatisFragment : BaseFragment(), OnChartValueSelectedListener {
    ...
    override fun initView() {
        ...
        initBarChartSetting(bc_sport_week)
        setData(bc_sport_week,getChartDate(), UIUtils.getColor(R.color.icon_green_color))
