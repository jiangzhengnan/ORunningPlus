...
import kotlinx.android.synthetic.main.fragment_step_deatail_week.*
import java.util.*
 ...
 */
class StepDetailWeekFragment : BaseFragment(), OnChartValueSelectedListener {
    ...
    override fun initView() {
        dsv_week.setListener(object : DateSelectView.onDateChageListener{
        ...
        initBarChartSetting(bc_step_week_detail)
        setData(bc_step_week_detail,getChartDate(), UIUtils.getColor(R.color.yellow_progress_color))
        initBarChartSetting(bc_distance_week_detail)
        setData(bc_distance_week_detail,getChartDate(), UIUtils.getColor(R.color.green_heart_color))
        initBarChartSetting(bc_calories_week_detail)
        setData(bc_calories_week_detail,getChartDate(), UIUtils.getColor(R.color.red_heart_color))
