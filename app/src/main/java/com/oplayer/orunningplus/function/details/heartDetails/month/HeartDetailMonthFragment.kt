...
import kotlinx.android.synthetic.main.fragment_heart_details_month.*
import java.util.*
 ...
 */
class HeartDetailMonthFragment : BaseFragment() {
    override fun onGetEvent(event: MessageEvent) {
        
    }

    override fun getLayoutId(): Int {
        return R.layout.fragment_heart_details_month
    }
