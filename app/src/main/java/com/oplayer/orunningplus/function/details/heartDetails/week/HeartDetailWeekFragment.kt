package com.oplayer.orunningplus.function.details.heartDetails.week
 ...
 */
class HeartDetailWeekFragment : BaseFragment() {
    override fun onGetEvent(event: MessageEvent) {
        
    }

    override fun getLayoutId(): Int {
        return R.layout.fragment_heart_details_week
    }
